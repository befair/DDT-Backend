# Generated by Django 3.1 on 2020-08-13 15:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp', models.CharField(default=api.utils.short_uuid, editable=False, max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ddt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='containers', to='api.ddt')),
            ],
            options={
